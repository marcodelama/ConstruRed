...
export function IconoConfig(props) {
  return (
    <svg
      ...
      {...props}
    >
      <mask id="IconifyId18bde28f9914c4cde1">
      ...
      <path
        fill="currentcolor"
        d="M0 0h48v48H0z"
        mask="url(#IconifyId18bde28f9914c4cde1)"
      />
    </svg>
  );
}
...
export function IconoHamburguesa(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
// Icono Home
export function IconoHome(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function Tablas(props) {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M9 21q-.825 0-1.412-.587T7 19V9q0-.825.588-1.412T9 7h10q.825 0 1.413.588T21 9v10q0 .825-.587 1.413T19 21zm1-10h8q.425 0 .713-.288T19 10q0-.425-.288-.712T18 9h-8q-.425 0-.712.288T9 10q0 .425.288.713T10 11m3 4h2v-2h-2zm0 4h2v-2h-2zm-4-4h2v-2H9zm8 0h2v-2h-2zm-8 4h2v-2H9zm8 0h2v-2h-2zM5 17q-.825 0-1.412-.587T3 15V5q0-.825.588-1.412T5 3h10q.825 0 1.413.588T17 5v1h-2V5H5v10h1v2z"
      />
    </svg>
  );
}
...
export function Biling(props) {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M6 22q-1.25 0-2.125-.875T3 19v-3h3V2l1.5 1.5L9 2l1.5 1.5L12 2l1.5 1.5L15 2l1.5 1.5L18 2l1.5 1.5L21 2v17q0 1.25-.875 2.125T18 22zm12-2q.425 0 .713-.288T19 19V5H8v11h9v3q0 .425.288.713T18 20M9 9V7h6v2zm0 3v-2h6v2zm8-3q-.425 0-.712-.288T16 8q0-.425.288-.712T17 7q.425 0 .713.288T18 8q0 .425-.288.713T17 9m0 3q-.425 0-.712-.288T16 11q0-.425.288-.712T17 10q.425 0 .713.288T18 11q0 .425-.288.713T17 12"
      />
    </svg>
  );
}
  ...
  return (
    ...
    >
      <path
        ...
        strokeLinejoin="round"
        strokeWidth="2"
        d="M16 4H9.5a3.5 3.5 0 0 0 0 7h.5m4 4V4m-4 11V4M5 19h14M7 21l-2-2l2-2"
      />
    </svg>
  );
}
...
// Icono Cerrado DropDown
export function IconoCierreDropDown(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
// Icono Apertura DropDown
export function IconoAperturaDropDown(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
// Icono Boockings
export function IconoBoockings(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
    ...
    >
      <path
        fill="currentColor"
        d="M4 20q-1.25 0-2.125-.875T1 17v-5q0-.825.588-1.412T3 10q.825 0 1.413.588T5 12v4h14v-4q0-.825.588-1.412T21 10q.825 0 1.413.588T23 12v5q0 1.25-.875 2.125T20 20zm3-6v-2q0-1.325-.862-2.325T4 8.3V7q0-1.25.875-2.125T7 4h10q1.25 0 2.125.875T20 7v1.3q-1.325.275-2.162 1.313T17 12v2z"
      />
    </svg>
  );
}
...
export function IconoAgregarPersona(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
// Icono de Inventory
export function IconoInventory(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function IconoTarjeta(props) {
  return (
    ...
    >
      <defs>
        <mask id="IconifyId18d03d0f912c953e1">
          <g fill="none">
            <path
              fill="#fff"
      ...
      <path
        fill="currentColor"
        d="M0 0h24v24H0z"
        mask="url(#IconifyId18d03d0f912c953e1)"
      />
    </svg>
  );
}
